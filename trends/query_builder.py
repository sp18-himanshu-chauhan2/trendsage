def build_perplexity_query(industry: str, region: str, persona: str, date_range: str) -> str:
    return (
        f"Find the top 5 trending topics for persona={persona} in the {industry} sector "
        ...
        "`engagement` (numeric 0-100 if available), `freshness` (numeric 0-100 if available), "
        "`relevance` (numeric 0-100 if available), `suggested_angles` (array of strings). "
        ...
        "{"
            '"results": ['
                '{'
                    ...
                    '"engagement": "number between 0-100",'
